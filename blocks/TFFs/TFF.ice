{
  ...
  "package": {
    "name": "TFF-verilog",
    "version": "0.2",
    "description": "System TFF with toggle input: It toogles on every system cycle if the input is active. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "6062d4c3-9a60-462b-ad4d-1688564906eb",
          "type": "basic.code",
          "data": {
            "ports": {
              "in": [
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "6062d4c3-9a60-462b-ad4d-1688564906eb",
            "port": "clk"
          }
        },
        {
