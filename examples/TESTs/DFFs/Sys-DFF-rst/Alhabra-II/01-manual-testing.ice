{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "07bd3866-b6d9-4373-9ada-d13496581d76",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "055644d1-3c16-416d-87e5-092dd8250a40",
        ...
        {
          "id": "b8ef352f-3616-4be4-b25a-d26fb271ed9e",
        ...
        {
          "id": "4a77f40f-2129-4280-b4f6-1bdbd359a27c",
          "type": "basic.constant",
          "data": {
            "name": "Init",
            "value": "0",
        ...
        {
          "id": "7c625582-403b-4759-b08e-23d748f1d1fc",
          "type": "basic.info",
          "data": {
            "info": "Initial value: cycle 0",
            "readonly": true
          },
          "position": {
            "x": 376,
        ...
        {
          "id": "4852fe59-4478-42e7-8c79-5e2864e6712f",
          "type": "c2cf3dc743e8e6bcf2a82ac9781eb9129e1ff0b2",
          "position": {
            "x": 712,
            "y": 368
          },
        ...
        {
          "id": "98ac76f5-64ec-42aa-a754-7196b82ba6ce",
          "type": "basic.info",
          "data": {
            "info": "LEDOscope",
            "readonly": true
        ...
        {
          "id": "c29fcbde-aef2-4288-a42c-e957716a2d5c",
        ...
        {
          "id": "756f220b-a9b5-4c15-94ff-6cca16260a77",
          "type": "basic.info",
          "data": {
            "info": "DFF",
            "readonly": true
        ...
        {
          "id": "f1057b47-d415-4a20-8dac-41579ea34a4b",
          "type": "basic.info",
          "data": {
            "info": "cycle 1",
            "readonly": true
        ...
        {
          "id": "216764ea-bca0-438c-acf8-962f61416bb8",
          "type": "basic.info",
          "data": {
            "info": "Rst on cycle 2",
            "readonly": true
        ...
        {
          "id": "51c2ff79-ca5c-487c-ae33-87b829d138d4",
        ...
        {
          "id": "59f635a4-9586-4a20-8cc3-2018e8724296",
          "type": "fab261c3353e927d3017b3dc7531d069c481515a",
          "position": {
            "x": 384,
            "y": 360
          },
      ...
      "wires": [
        {
          "source": {
            "block": "4a77f40f-2129-4280-b4f6-1bdbd359a27c",
            "port": "constant-out"
          },
          "target": {
            "block": "59f635a4-9586-4a20-8cc3-2018e8724296",
            "port": "63e9825a-4f37-4c3c-b118-e2bbd28d5ac7"
          }
        },
        {
          "source": {
            "block": "4852fe59-4478-42e7-8c79-5e2864e6712f",
            "port": "5d13c0fd-f2cd-410a-a3ee-fddf5a2eeb31"
          },
          "target": {
            "block": "07bd3866-b6d9-4373-9ada-d13496581d76",
            "port": "in"
          },
          "size": 4
        },
        {
          "source": {
            "block": "c29fcbde-aef2-4288-a42c-e957716a2d5c",
        ...
        },
        {
          ...
          "target": {
            "block": "51c2ff79-ca5c-487c-ae33-87b829d138d4",
        ...
        {
          "source": {
            "block": "055644d1-3c16-416d-87e5-092dd8250a40",
            "port": "outlabel"
          },
          "target": {
            "block": "59f635a4-9586-4a20-8cc3-2018e8724296",
        ...
        },
        {
          ...
          "target": {
            "block": "b8ef352f-3616-4be4-b25a-d26fb271ed9e",
            "port": "inlabel"
          }
        }
      ]
  ...
  "dependencies": {
    "c2cf3dc743e8e6bcf2a82ac9781eb9129e1ff0b2": {
      "package": {
    ...
    "fab261c3353e927d3017b3dc7531d069c481515a": {
      "package": {
        "name": "Sys-DFF-rst-block",
        "version": "0.6",
        "description": "Sys-DFF-rst: D Flip flop with reset input. When rst=1, the DFF is set to it initial value. Block implementation",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20width=%22196.313%22%20height=%22216.83%22%20viewBox=%220%200%2051.941051%2057.369679%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg%20transform=%22translate(-52.22%20-48.028)%22%3E%3Crect%20width=%2224.412%22%20height=%2213.185%22%20x=%2279.352%22%20y=%2253.67%22%20ry=%222.247%22%20fill=%22#fff%22%20stroke=%22#000%22%20stroke-width=%22.794%22%20stroke-linecap=%22round%22/%3E%3Cg%20stroke=%22#000%22%20stroke-width=%221.442%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%3E%3Cpath%20d=%22M77.902%2088.18l13.607%2016.672-6.918-20.534%22%20fill=%22#ccc%22%20stroke-width=%221.0924880399999999%22/%3E%3Cpath%20d=%22M70.517%2080.116l-9.232-19.613-6.45%203.725-2.07-3.584%2020.905-12.07%202.07%203.584-6.093%203.518%2012.03%2018.222s5.4-2.025%208.536.74c3.136%202.766%202.52%204.92%202.887%204.773L69.412%2093.049s-2.848-3.696-2.16-6.796c.687-3.1%203.265-6.137%203.265-6.137z%22%20fill=%22red%22%20stroke-width=%221.0924880399999999%22/%3E%3C/g%3E%3Ctext%20style=%22line-height:1.25%22%20x=%2281.296%22%20y=%2263.239%22%20font-weight=%22400%22%20font-size=%2210.583%22%20font-family=%22sans-serif%22%20fill=%22#00f%22%20stroke-width=%22.265%22%3E%3Ctspan%20style=%22-inkscape-font-specification:'sans-serif%20Bold'%22%20x=%2281.296%22%20y=%2263.239%22%20font-weight=%22700%22%3ESys%3C/tspan%3E%3C/text%3E%3C/g%3E%3C/svg%3E",
        "otid": 1617895961660
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "f95611a0-921f-42ba-a77e-47c3738756ca",
              "type": "basic.inputLabel",
              "data": {
                "name": "clk",
                "blockColor": "yellow",
            ...
            {
              "id": "5402ebdf-2092-46b4-adfd-edd23c5eaf73",
              "type": "basic.inputLabel",
              "data": {
                "name": "rst",
                "blockColor": "fuchsia",
            ...
            {
              "id": "1dea3b9a-d763-47bf-8454-763afe88cfa2",
              "type": "basic.outputLabel",
              "data": {
                "name": "clk",
                "blockColor": "yellow",
            ...
            {
              "id": "7816eac1-a702-4bf1-8bce-c4acaaea6c0c",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "blockColor": "fuchsia",
            ...
            {
              "id": "d99a9bef-348a-4991-99c4-19d7921e8b95",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "blockColor": "fuchsia",
            ...
            {
              "id": "8c85ccfe-af0a-40cc-97ea-df241ca6591f",
              "type": "basic.outputLabel",
              "data": {
                "name": "rst",
                "blockColor": "fuchsia",
            ...
            {
              "id": "003f155c-8564-4270-bd2f-5307fd6a72c0",
              "type": "58ed2b5c7e33e2f215ccba6c101d9ea4ff60f284",
              "position": {
                "x": 888,
                "y": -32
            ...
            {
              "id": "f0144a2a-779a-4446-aab1-24391b875320",
            ...
            {
              "id": "672aed12-36e2-45e2-8c8c-d9fe585efbeb",
            ...
            {
              "id": "421592b4-a78b-4113-8f6d-781595bac61c",
              "type": "basic.info",
              "data": {
            ...
            {
              "id": "1218bfa8-2b9e-4b3c-aae8-603ec26c0d63",
              "type": "basic.info",
              "data": {
                "info": "Mux-2-1",
                "readonly": true
            ...
            {
              "id": "cc581896-5731-4586-be14-00ac1b8ba558",
              "type": "basic.info",
              "data": {
                "info": "Sys-DFF",
                "readonly": true
          ...
          "wires": [
            {
              ...
              "target": {
                "block": "5402ebdf-2092-46b4-adfd-edd23c5eaf73",
                "port": "inlabel"
              }
            },
            {
              ...
              "target": {
                "block": "f95611a0-921f-42ba-a77e-47c3738756ca",
                "port": "inlabel"
              }
            },
            {
              ...
              "target": {
                "block": "d99a9bef-348a-4991-99c4-19d7921e8b95",
                "port": "inlabel"
              }
            },
            {
              "source": {
                "block": "1dea3b9a-d763-47bf-8454-763afe88cfa2",
                "port": "outlabel"
              },
              "target": {
                "block": "003f155c-8564-4270-bd2f-5307fd6a72c0",
                "port": "3943e194-090b-4553-9df3-88bc4b17abc2"
              }
            },
            {
              "source": {
                "block": "7816eac1-a702-4bf1-8bce-c4acaaea6c0c",
                "port": "outlabel"
              },
              "target": {
                "block": "f0144a2a-779a-4446-aab1-24391b875320",
                "port": "a50d1088-061e-4af0-89cd-59567d3904ee"
              }
            },
            {
              "source": {
                "block": "8c85ccfe-af0a-40cc-97ea-df241ca6591f",
                "port": "outlabel"
              },
              "target": {
                "block": "f0144a2a-779a-4446-aab1-24391b875320",
            ...
            {
              "source": {
                "block": "672aed12-36e2-45e2-8c8c-d9fe585efbeb",
