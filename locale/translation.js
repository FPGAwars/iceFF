...
gettext('DFF-TB');
gettext('DFF Testbench. Test if a DFF works ok');
...
gettext('The error flag is reset when a  \nnew capture is started');
gettext('d(t) q(t) q(t+1)');
gettext('4-bits counting  \nmahcine');
gettext('Increase the count  \non every cycle');
gettext('## Input data generation\n\nGenerate the inputs for the Flip-Flop according  \nto the table. The correct values (q(t) and q(t+1))  \nare given');
gettext('Stop the machine in case  \nof error found');
gettext('## Busy Flag  \nThe circuit is busy for one more  \ncycle than busy1');
gettext('## Auto-check result\n\nDepeding on the error_flag, the end_tic is sent  \nthrough the error pin or done pin  \n* done: Check ok\n* error: Check not ok');
gettext('end tic');
gettext('The bits of the signal  \nare only valid when the  \nmachine is on');
gettext('Current output  \ncorrect value');
gettext('Output in next cycle  \ncorrect value');
...
gettext('Bits sent to the  \nD Flip-Flops');
gettext('Response from the  \nD Flip-Flop');
gettext('Icerok output');
